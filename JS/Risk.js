...
function allResults() {
    ...
    battleTotalRender(document.getElementById("resultsAllTotals"), total, i);
}
...
function battleBlank() {
    ...
    battleTotalRender(document.getElementById("resultsBattleTotals"), total, i);
}
...
function battleTotalRender(div, total, totalNumber) {
    div.innerHTML += "Attacker wins: <b>" + total[0] + "</b> (" + (total[0] / totalNumber * 100).toFixed(2) + "%)<br/>";
    div.innerHTML += "Tie: <b>" + total[1] + "</b> (" + (total[1] / totalNumber * 100).toFixed(2) + "%)<br/>";
    div.innerHTML += "Defender wins: <b>" + total[2] + "</b> (" + (total[2] / totalNumber * 100).toFixed(2) + "%)<br/>";
